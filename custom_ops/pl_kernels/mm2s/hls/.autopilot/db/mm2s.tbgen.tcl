...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "id_num" : 1, "bitSlice":[ {"cElement": [{"cName": "mem","offset": { "type": "dynamic","port_name": "mem","bundle": "control"},"direction": "READONLY"}]}]} , 
...
set portList { 
	...
	{ s_TREADY sc_in sc_logic 1 outacc 5 } 
	...
	{ s_TVALID sc_out sc_logic 1 outvld 5 } 
	{ s_TKEEP sc_out sc_lv 4 signal 3 } 
	{ s_TSTRB sc_out sc_lv 4 signal 4 } 
	{ s_TLAST sc_out sc_lv 1 signal 5 } 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"mm2s","role":"start","value":"0","valid_bit":"0"},{"name":"mm2s","role":"continue","value":"0","valid_bit":"4"},{"name":"mm2s","role":"auto_start","value":"0","valid_bit":"7"},{"name":"mem","role":"data","value":"16"},{"name":"size","role":"data","value":"28"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"mm2s","role":"start","value":"0","valid_bit":"0"},{"name":"mm2s","role":"done","value":"0","valid_bit":"1"},{"name":"mm2s","role":"idle","value":"0","valid_bit":"2"},{"name":"mm2s","role":"ready","value":"0","valid_bit":"3"},{"name":"mm2s","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "control", "role": "interrupt" } }, 
 	...
 	{ "name": "s_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "s_V_last_V", "role": "default" }} , 
...
set ArgLastReadFirstWriteLatency {
	mm2s {
		...
		s_V_data_V {Type O LastRead -1 FirstWrite 75}
		s_V_keep_V {Type O LastRead -1 FirstWrite 75}
		s_V_strb_V {Type O LastRead -1 FirstWrite 75}
		s_V_last_V {Type O LastRead -1 FirstWrite 75}
