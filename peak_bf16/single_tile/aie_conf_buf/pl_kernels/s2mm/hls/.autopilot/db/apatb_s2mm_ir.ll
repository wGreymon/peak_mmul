; ModuleID = '/home/jnz/versal-aie/peak_mmul/peak_bf16/single_tile/aie_conf_buf/pl_kernels/s2mm/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_s2mm_ir(%"struct.ap_int<32>"* noalias nocapture nonnull "maxi" %mem, %"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull align 4 dereferenceable(12) %s, i32 %size) local_unnamed_addr #0 {
entry:
...
declare void @s2mm_hw_stub(%"struct.ap_int<32>"* noalias nocapture nonnull, %"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull, i32)
...
entry:
  ...
  call void @s2mm_hw_stub(%"struct.ap_int<32>"* %7, %"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0, '8', false>, 0>"* %9, i32 %5)
