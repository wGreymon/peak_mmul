; ModuleID = '/home/jnz/versal-aie/peak_mmul/peak_bf16/single_tile/aie_conf_buf/pl_kernels/mm2s/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_mm2s_ir(%"struct.ap_int<32>"* noalias nocapture nonnull readonly "maxi" %mem, %"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull align 4 dereferenceable(12) %s, i32 %size) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_mm2s_hw(i32* %mem_copy, i32* %s_copy.data, i4* %s_copy.keep, i4* %s_copy.strb, i1* %s_copy.last, i32 %size)
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0, '8', false>, 0>.20"(i32* align 512 %_V_data_V, i4* align 512 %_V_keep_V, i4* align 512 %_V_strb_V, i1* align 512 %_V_last_V, %"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0, '8', false>, 0>"* %2)
  ret void
}
...
entry:
  call fastcc void @"onebyonecpy_hls.p0struct.ap_int<32>.13"(%"struct.ap_int<32>"* %0, i32* align 512 %1)
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_int<32>.13"(%"struct.ap_int<32>"* noalias "unpacked"="0" %dst, i32* noalias nocapture readonly align 512 "unpacked"="1.0" %src) unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0, '8', false>, 0>.20"(i32* noalias align 512 "unpacked"="0.0" %dst_V_data_V, i4* noalias align 512 "unpacked"="0.1" %dst_V_keep_V, i4* noalias align 512 "unpacked"="0.2" %dst_V_strb_V, i1* noalias align 512 "unpacked"="0.3" %dst_V_last_V, %"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0, '8', false>, 0>"* noalias %src) unnamed_addr #3 {
entry:
  %0 = icmp eq %"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0, '8', false>, 0>"* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0, '8', false>, 0>.23"(i32* align 512 %dst_V_data_V, i4* align 512 %dst_V_keep_V, i4* align 512 %dst_V_strb_V, i1* align 512 %dst_V_last_V, %"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0, '8', false>, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0, '8', false>, 0>.23"(i32* noalias nocapture align 512 "unpacked"="0.0" %_V_data_V, i4* noalias nocapture align 512 "unpacked"="0.1" %_V_keep_V, i4* noalias nocapture align 512 "unpacked"="0.2" %_V_strb_V, i1* noalias nocapture align 512 "unpacked"="0.3" %_V_last_V, %"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0, '8', false>, 0>"* noalias nocapture) unnamed_addr #4 {
entry:
...
declare void @apatb_mm2s_hw(i32*, i32*, i4*, i4*, i1*, i32)
...
declare void @mm2s_hw_stub(%"struct.ap_int<32>"* noalias nocapture nonnull readonly, %"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull, i32)

define void @mm2s_hw_stub_wrapper(i32*, i32*, i4*, i4*, i1*, i32) #6 {
entry:
  %6 = call i8* @malloc(i64 4)
  %7 = bitcast i8* %6 to %"struct.ap_int<32>"*
  %8 = call i8* @malloc(i64 12)
  %9 = bitcast i8* %8 to %"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0, '8', false>, 0>"*
  call void @copy_out(%"struct.ap_int<32>"* %7, i32* %0, %"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0, '8', false>, 0>"* %9, i32* %1, i4* %2, i4* %3, i1* %4)
  call void @mm2s_hw_stub(%"struct.ap_int<32>"* %7, %"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0, '8', false>, 0>"* %9, i32 %5)
  call void @copy_in(%"struct.ap_int<32>"* %7, i32* %0, %"class.hls::stream<hls::axis<ap_int<32>, 0, 0, 0, '8', false>, 0>"* %9, i32* %1, i4* %2, i4* %3, i1* %4)
  call void @free(i8* %6)
  call void @free(i8* %8)
  ret void
}
